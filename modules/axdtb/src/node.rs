...
use crate::byte_util::{align_size, locate_block, read_aligned_be_u32, read_aligned_name};
use crate::tree::InheritedValues;
...
impl DeviceTreeNode {
    ...
    pub fn find_child_type(&self, name: &str) -> Option<Vec<&DeviceTreeNode>> {
        let mut ret = Vec::new();
    ...
    pub fn find_prop(&self, name: &str) -> Option<&NodeProperty> {
    ...
    pub fn of_value(&self, name: &str) -> Option<&PropertyValue> {
