...
use crate::type1_5::consts::PER_CPU_SIZE;
...
impl PerCpu {
    ...
    //         return Err(HvError::new(HvErrorNum::EINVAL, file!(), line!(), column!(), None));
    //     }
    ...
    //     ax_println!("Activating hypervisor on CPU {}...", self.id);
    ...
    //     ax_println!("Deactivating hypervisor on CPU {}...", self.id);
